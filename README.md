...
## 安裝
### v1
1. 下載[台南一中學習歷程備份系統](https://github.com/EF-Lin/TNFSH-Learning-Portfolio-Backup-System/archive/refs/heads/master.zip)zip檔並解壓縮至本機。
2. 運行"TNFSH_Backup_System_v1.exe"。
...
3. 下載[台南一中學習歷程備份系統](https://github.com/EF-Lin/TNFSH-Learning-Portfolio-Backup-System/archive/refs/heads/master.zip)zip檔並解壓縮至本機。
4. 運行"setup.bat"。
5. 確認運行過程中沒有出現紅字，有的話請檢查Python以及基本套件是否安裝正確或查看[常見錯誤](#無法運行v2版本系統)。
6. 運行"TNFSH_Learning_Portfolio_Backup_System_v2.bat"。
