...
>[!WARNING]
>由於本專案創設之初僅作為高三Python程式設計課程的期末專案，當時我並未具備良好程設能力，導致專案中的依賴、版本、結構與代碼皆混亂不堪，專案也因此缺乏管理與可維護性。其次，我畢業至今已過一年，學習歷程系統帳號早被註銷無法進行任何測試。在權衡考量後我認為目前應不具備持續維護此專案的能力，故決定永久擱置"台南一中學習歷程備份系統"，不再進行任何更新。
>
>但願每一行敲下的程式，都能成為未來的基石。
>
>114/08/22 EFLin
